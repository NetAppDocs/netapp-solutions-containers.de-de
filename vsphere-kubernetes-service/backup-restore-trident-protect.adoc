...
[%collapsible]
====
Dieses Beispiel behandelt den Datenschutz für die Beispielanwendung postgres, die im Namespace postgres installiert ist. Einzelheiten zur Installation finden sich unter link:/vsphere-kubernetes-service/deploy-vks-workloads.html["VKS-Workloads mit NetApp Storage bereitstellen"].
