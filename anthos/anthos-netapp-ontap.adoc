...
Weitere Informationen zu NetApp AFF und FAS Plattformen finden sich im link:https://docs.netapp.com/platstor/index.jsp["NetApp Hardwareplattform-Dokumentation"^].
