...
Trident, ein von NetApp gepflegter Open-Source-Speicherbereitsteller und -Orchestrator, bietet zusammen mit seinem Add-on, NetApp Trident Protect, robuste Lösungen für die Orchestrierung und Verwaltung persistenter Daten in containerbasierten Umgebungen wie Red Hat OpenShift.
