...
[role="lead"]
Für die meisten Deployments von Red Hat OpenShift erfüllt die Verwendung einer öffentlichen Registry wie link:https://quay.io["Quay.io"^] oder link:https://hub.docker.com["DockerHub"^] die Bedürfnisse der meisten Kunden. Es gibt jedoch Fälle, in denen ein Kunde eigene private oder angepasste Images hosten möchte.
