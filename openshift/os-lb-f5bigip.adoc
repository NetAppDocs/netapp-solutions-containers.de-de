...
. Die F5 Application Services 3 Erweiterung installieren, damit BIG-IP Systeme Konfigurationen im JSON-Format anstelle von imperativen Befehlen akzeptieren. Zu link:https://github.com/F5Networks/f5-appsvcs-extension/releases["F5 AS3 GitHub-Repository"^] gehen und die neueste RPM-Datei herunterladen.
