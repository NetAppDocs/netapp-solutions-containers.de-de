...
Weitere Informationen sind in der link:https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.2/["Red Hat Advanced Cluster Management Dokumentation"^] zu finden.
