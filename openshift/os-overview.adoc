...
. Befolgen Sie die von Red Hat bereitgestellten link:https://docs.openshift.com/container-platform/4.7/installing/index.html["Installationsanweisungen"^] Anweisungen, um die Bereitstellung in Ihrer gewünschten Umgebung durchzuführen.
...
* link:os-on-bm.html["OpenShift auf Bare Metal"]
* link:os-on-openstack.html["OpenShift auf der Red Hat OpenStack-Plattform"]
* link:os-on-rhv.html["OpenShift auf Red Hat Virtualization"]
* link:os-on-vmw.html["OpenShift auf VMware vSphere"]
