...
Informationen zum Konfigurieren von Affinitätsgruppen finden Sie imlink:https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.resmgmt.doc/GUID-FF28F29C-8B67-4EFF-A2EF-63B3537E6934.html["vSphere 6.7-Dokumentation: Verwenden von DRS-Affinitätsregeln"^] .
