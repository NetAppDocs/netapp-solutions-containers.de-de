...
Einzelheiten zur Installation und Konfiguration finden Sie in der link:https://docs.netapp.com/us-en/trident/index.html["Trident -Produktdokumentation"^].
...
. Das Installationsarchiv wird auf den Administratorarbeitsplatz heruntergeladen und der Inhalt extrahiert. Die aktuelle Version von Trident kann von der link:https://github.com/NetApp/trident/releases?q=25.&expanded=true["Trident Releases-Seite auf GitHub"^] heruntergeladen werden.
