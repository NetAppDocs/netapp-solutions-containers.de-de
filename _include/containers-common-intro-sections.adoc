...
NetApp Trident ist ein Open-Source- und vollständig unterstützter Storage-Orchestrator für Container und Kubernetes-Distributionen wie {k8s_distribution_name}. Weitere Informationen sind unter link:https://docs.netapp.com/us-en/trident/index.html["Trident Dokumentation"^] verfügbar.
...
Eine Supportmatrix dazu, welche Version von Trident mit welcher Kubernetes-Distribution getestet wurde, befindet sich in link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["Unterstützte Frontends (Orchestratoren)"^].
